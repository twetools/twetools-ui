        ...
        {variant === "primary" && (
          <>
            ...
            <path
              ...
              stroke="#465FFF"
              strokeWidth="8"
              mask={`url(#path-2-inside-1_3755_26202-${size})`}
            />
          </>
        )}
